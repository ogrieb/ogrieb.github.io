...
{% include figure.html img="2017-01-22-blockchain-overview.svg"
    cap="Figure 1. [_Simplified Bitcoin Block Chain_][1] by unknown, licensed under the [MIT license][2]. _Developer Guide_, Bitcoin Project. Accessed 22 January 2017. [1]: https://bitcoin.org/en/developer-guide#block-chain [2]: http://opensource.org/licenses/mit-license.php" %}
